...
fn main() {
    let ans = part1("C:/git/advent_of_code/day5/input/test1.txt");
    println!("part 1 test 1 answer: {}", ans);

    let ans = part1("C:/git/advent_of_code/day5/input/test2.txt");
    println!("part 1 test 2 answer: {}", ans);

    let ans = part2("C:/git/advent_of_code/day5/input/test1.txt");
    println!("part 2 test 1 answer: {}", ans);

    let ans = part2("C:/git/advent_of_code/day5/input/test2.txt");
...
#[test]
fn part1_test1() {
    let result = part1("C:/git/advent_of_code/day5/input/test1.txt");
    assert_eq!(result, 35);
}

#[test]
fn part1_test2() {
    let result = part1("C:/git/advent_of_code/day5/input/test2.txt");
    assert_eq!(result, 278755257);
}

#[test]
fn part2_test1() {
    let result = part2("C:/git/advent_of_code/day5/input/test1.txt");
    assert_eq!(result, 46);
}

#[test]
fn part2_test2() {
    let result = part2("C:/git/advent_of_code/day5/input/test2.txt");
